...
class BaseCalendar:
    def __init__(self, parent, selected_year, country=None):
        self.parent = parent
    ...
    def show_calendar(self):
        ...
        for month in range(1, 13):
            self._create_month_frame(month, month_names, special_dates, 4)
...
class QuarterCalendar(BaseCalendar):
    ...
    def show_quarter_calendar(self):
        ...
        for month_in in range(3):
            ...
            self._create_month_frame(month, month_names, special_dates, 3)
